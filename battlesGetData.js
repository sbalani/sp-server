...
console.log("battlegetdata is running");
...
async function getBattleHistory(player = '', data = {}) {
    ...
    //console.log("initial pull" + JSON.stringify(battleHistory.battles));
...
const extractMonster1 = (team) => {
    ...
    return {
        t1_summoner_id: team.summoner.card_detail_id,
        t1_summoner_level: team.summoner.level,
        t1_monster_1_id: monster1 ? monster1.card_detail_id : '',
        t1_monster_1_level: monster1 ? monster1.level : '',
        t1_monster_1_abilities: monster1 ? monster1.abilities : '',
        t1_monster_2_id: monster2 ? monster2.card_detail_id : '',
        t1_monster_2_level: monster2 ? monster2.level : '',
        t1_monster_2_abilities: monster2 ? monster2.abilities : '',
        t1_monster_3_id: monster3 ? monster3.card_detail_id : '',
        t1_monster_3_level: monster3 ? monster3.level : '',
        t1_monster_3_abilities: monster3 ? monster3.abilities : '',
        t1_monster_4_id: monster4 ? monster4.card_detail_id : '',
        t1_monster_4_level: monster4 ? monster4.level : '',
        t1_monster_4_abilities: monster4 ? monster4.abilities : '',
        t1_monster_5_id: monster5 ? monster5.card_detail_id : '',
        t1_monster_5_level: monster5 ? monster5.level : '',
        t1_monster_5_abilities: monster5 ? monster5.abilities : '',
        t1_monster_6_id: monster6 ? monster6.card_detail_id : '',
        t1_monster_6_level: monster6 ? monster6.level : '',
        t1_monster_6_abilities: monster6 ? monster6.abilities : ''
    }
}


const extractMonster2 = (team) => {
    const monster1 = team.monsters[0];
    const monster2 = team.monsters[1];
    const monster3 = team.monsters[2];
    const monster4 = team.monsters[3];
...
const extractwinlose = (player1, player2, winner, loser) => {
        ...
        .then(battles => battles.map(
            battle => {
                ...
                if (details.type != 'Surrender') {
                   //console.log("battle details:" +  JSON.stringify(details));
                    const monstersDetails1 = extractMonster1(details.team1);
                    const info = extractGeneralInfo(battle);
                    const player1 = battle.player_1;
                    const player2 = battle.player_2;
                    const winner = details.winner;
                    const loser = details.loser;
                    const winlose = extractwinlose(player1, player2, winner, loser);
                    const monstersDetails2 = extractMonster2(details.team2);
                        return {
                            ...monstersDetails2,
                            ...info,
                            battle_queue_id_2: battle.battle_queue_id_2,
                            player_rating_initial_2: battle.player_2_rating_initial,
                            player_rating_final_2: battle.player_2_rating_final,
                            ...monstersDetails1,
                            
                            battle_queue_id_1: battle.battle_queue_id_1,
                            player_rating_initial_1: battle.player_1_rating_initial,
                            player_rating_final_1: battle.player_1_rating_final,
                            winner: winner, loser: loser, player1: player1, player2: player2, winlose_1: winlose.t1_winlose, winlose_2: winlose.t2_winlose,
                        }
...
Promise.all(battles).then(() => {
   ...
   //console.log("battledetails:" + JSON.stringify(battlesList))

    const cleanBattleList = battlesList.filter(x => x != undefined)

    // console.log("cleanbattlelist:" + JSON.stringify(cleanBattleList));
...
pool.execute(sql, function (err, result) {
  ...
  */
     ...
     fetch("http://localhost:3000/posts/", {
        method: "post",
        body: JSON.stringify(cleanBattleList),
